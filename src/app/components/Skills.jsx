  ...
  return (
    <div className="text-white p-5 flex flex-col justify-center items-center text-center md:text-left md:items-start">
      ...
      >
        ...
        <span className="text-myGreen"> CSS3 , SASS / SCSS </span>. Experienced
        in developing dynamic and interactive web applications using
        <span className="text-myGreen"> JavaScript , TypeScript </span>.
        Knowledgeable in using
        <span className="text-myGreen"> Bootstrap , Tailwind </span> frameworks
        for building responsive, mobile-first websites and creating custom
        designs. Proficient in version control using
        <span className="text-myGreen"> Git </span>
        for collaborative development. Adept at building modern web applications
        with <span className="text-myGreen"> React , Next.js </span>, focusing
        on component-based architecture. Experienced in using
