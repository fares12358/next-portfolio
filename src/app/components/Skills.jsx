...
const Skills = () => {
  return (
    <div className="text-white p-5 flex flex-col justify-center items-center text-center md:text-left md:items-start">
      ...
      <p
        className="text-neutral-500 font-base md:text-lg text-sm opacity-0 translate-y-3 anim-view relative"
      ...
      <div className=" w-full my-10 rounded-md grid md:grid-cols-4 grid-cols-2 gap-5 p-4">
        <div
          className="bg-[#28272c] p-5 rounded-lg flex flex-col text-6xl opacity-0 translate-y-3 anim-view relative"
